...
#include <linux/cpufreq.h> //WJH based on KTOONSEZ code!
...
static bool capture_orig = false; //WJH based on KTOONSEZ code!
...
void get_stock_table(void) // WJH based on KTOONSEZ code!
{
	if (!capture_orig)
	{
		int i;
